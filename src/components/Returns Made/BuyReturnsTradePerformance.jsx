...
const BuyReturnsTradePerformance = () => {
  ...
  useEffect(() => {
    setIsNegativeTransaction(!(companyBought.current_change > 0));
    const newCompany = {
      sell_buy: companyBought.current_price,
      price_change: companyBought.current_change,
      worth: companyBought.temp_price,
    };
    ...
    <div className="flex flex-col gap-4 py-[20px]">
      <div className="relative w-full flex justify-center items-center">
        <div className="w-[100px] h-[100px] bg-white p-3 flex justify-center items-center rounded-full">
          <img
            src={`/images/trade-performance-buy.svg`}
            alt="Buy Returns"
            className=""
          />
        </div>
...
export default BuyReturnsTradePerformance;
