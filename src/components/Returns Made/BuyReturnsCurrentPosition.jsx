...
const BuyReturnsCurrentPosition = () => {
  const { postBuyPosition } = useGlobal();
  return (
    <div className="w-full h-full flex justify-between items-center py-[50px]">
      <div className="bg-white rounded-3xl p-7 flex flex-col gap-3 w-[32%]">
        ...
        <div className="font-medium text-[48px] leading-[61px]">
          {postBuyPosition?.sharesQuantity}{" "}
      ...
      <div className="bg-white rounded-3xl p-7 flex flex-col gap-3 w-[32%]">
        ...
        <Price
          price={postBuyPosition?.sharePrice.toFixed(2)}
          imgStyles={"w-[25px]"}
      ...
      <div className="bg-white rounded-3xl p-7 flex flex-col gap-3 w-[32%]">
        ...
        <div className="font-medium text-[48px] leading-[61px]">
          <Price
            price={postBuyPosition?.valueOfShares.toFixed(2)}
            imgStyles={"w-[25px]"}
            textStyles={"font-medium text-[48px] leading-[61px]"}
          />
        </div>
...
export default BuyReturnsCurrentPosition;
